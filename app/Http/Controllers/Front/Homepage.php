...
class Homepage extends Controller
{
    ...
    public function contactpost(Request $request){
        ...
        Mail::send([],[], function($message) use($request){
           $message->from('iletisim@furkanbakal.com','Furkan Bakal');
           $message->to('f.bakal1997@gmail.com');
        ...
        // $contact->save();
        return redirect()->route('contact')->with('success','İletişim mesajınız iletildi.Teşekkür ederiz!');
    }
}
